        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinAgeGroup = table.Column<string>(type: "text", nullable: false),
                    SubscriptionFilter = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SimulationQuestions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SimulationQuestions_Simulations_SimulationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Order = table.Column<int>(type: "integer", nullable: false),
                    AgeGroupFilter = table.Column<string>(type: "text", nullable: true),
                    SubscriptionFilter = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SimulationOptions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SimulationOptions_SimulationQuestions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "SimulationQuestions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SurveyResponses_SurveyOptions_SelectedOptionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SimulationOptions_QuestionId",
                table: "SimulationOptions",
                column: "QuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_SimulationQuestions_SimulationId",
                table: "SimulationQuestions",
                column: "SimulationId");
